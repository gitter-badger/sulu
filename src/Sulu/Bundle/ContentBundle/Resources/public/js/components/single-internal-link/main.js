    ...
    var defaults = {
        ...
        templates = {
            skeleton: function(options) {
                return [
                    '<div class="single-internal-link container white form-element" id="', options.ids.container, '">',
                    '   <a class="fa-search fa-flip-horizontal choose" href="#" id="', options.ids.button, '"></a>',
